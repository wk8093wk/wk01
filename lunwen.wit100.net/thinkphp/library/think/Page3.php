...
//        $this->nowPage    = empty($_REQUEST[$this->p]) ? 1 : intval($_REQUEST[$this->p]);        
     ...
     */
	 ...
	 public function show3() {
        ...
        $up_page = $up_row > 0 ? '<a class="prev" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a>' : '<a class="prev on" href="javacript:void(0);">' . $this->config['prev'] . '</a>';
        ...
        $down_page = ($down_row <= $this->totalPages) ? '<a class="next" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a>' : '<a class="next on" href="javacript:void(0);">' . $this->config['next'] . '</a>';
